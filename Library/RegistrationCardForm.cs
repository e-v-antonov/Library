...
namespace Library
{
    public partial class RegistrationCardForm : Form
    {
        ...
        private void RegistrationCardForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            regCardDependency.Stop();
            regCardDependency.OnChanged += null;
        }
    }

    public class Registration_Card_Reader
    {
        public int ID_Registration_Card_Reader { get; set; }
        public string Surname_Reader { get; set; }
        public string Name_Reader { get; set; }
        public string Patronymic_Reader { get; set; }
        public DateTime Birthday_Reader { get; set; }
        public string Passport_Series_Reader { get; set; }
        public string Passport_Number_Reader { get; set; }
        public string Who_Give_Passport_Reader { get; set; }
        public string When_Give_Passport_Reader { get; set; }
        public string Town_Reader { get; set; }
        public string Street_Reader { get; set; }
        public int Building_Reader { get; set; }
        public int Apartment_Reader { get; set; }
        public string Home_Phone_Reader { get; set; }
        public string Mobile_Phone_Reader { get; set; }
        public string Email_Reader { get; set; }
        public DateTime Registration_Date_Reader { get; set; }
        public int Book_On_Hand_Reader { get; set; }
        public int Registration_Card_Reader_Logical_Delete { get; set; }
    }
}
